...
CREATE TABLE IF NOT EXISTS Iscrizione (
    ...
    StatoIscrizione ENUM('Attiva', 'Scaduta', 'Sospesa'),
...
INSERT INTO Attivita (NomeAttivita, Orario, GiornoSettimana, Durata, ID_Istruttore) VALUES
...
INSERT INTO Socio (Nome, Cognome, DataNascita, ContattoTelefonico) VALUES
('Giulia', 'Neri', '1990-05-15', '3331234567'),
('Paolo', 'Gialli', '1985-10-22', '3345678901'),
('Sara', 'Blu', '1995-03-08', '3356789012');

INSERT INTO Iscrizione (DataIscrizione, DataFineIscrizione, StatoIscrizione, ID_Socio, ID_Attivita) VALUES
